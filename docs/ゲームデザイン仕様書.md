...
const bgmSettings = {
  title: {
    ...
    volume: 0.3,
    generated: 'Vertex AI MusicLM', // AI生成BGM
    copyright: 'royalty-free'       // 著作権フリー
  },
  gameplay: {
    tempo: 120,
    ...
    volume: 0.2,
    file: 'music1.wav',             // 実装済みファイル
    generated: 'Vertex AI MusicLM'
  },
  result: {
    tempo: 130,
...
### 6.3 音声ガイド（Google Vertex AI設定）
```typescript
const voiceSettings = {
  languageCode: 'ja-JP',    // 日本語
  voiceName: 'ja-JP-Wavenet-A',  // 日本語女性の声
  ssmlGender: 'FEMALE',     // 女性の声
  speakingRate: 0.9,        // 話速（少しゆっくり）
  pitch: 0.0,               // ピッチ（標準）
  volumeGainDb: 0.0,        // 音量（標準）
};
...
const voiceLines = {
  ...
  excellent: 'よくできたね。', // 実装済み（speech.wav）
};

// Vertex AI Text-to-Speech API実装
